...
public class lightingParams
{
	...
	//Material properties of the cone for phong shading 
	...
	//Material properties of the sphere for gouraud and flat shading
	float ambient_color1[] = { (float) 1, (float) 1, (float) 1, (float) 1};
	float diffuse_color1[] = { (float) 1, 1, (float)1, 1};
	float specular_color1[] = { (float) 1, (float) 1, (float) 1, (float) 1};
    ...
    public void setUpPhong (int program, GL3 gl3)
    {
    	...
    	//All values are being sent to the vertex shader of phong, gouraud and flat shading
    	...
    	gl3.glUniform4fv(gl3.glGetUniformLocation(program, "ambientColor1"), 1, ambient_color1, 0);
    	gl3.glUniform4fv(gl3.glGetUniformLocation(program, "diffuseColor1"), 1, diffuse_color1, 0);
    	gl3.glUniform4fv(gl3.glGetUniformLocation(program, "specularColor1"), 1, specular_color1, 0);
